...
public class RabbitmqService implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback {
    ...
    public void returnedMessage(Message message, int replyCode, String replyText, String exchange, String routingKey) {
        System.err.println(("---- returnedMessage ----replyCode=" + replyCode + " replyText=" + replyText + " "));
    }
    ...
    public void confirm(CorrelationData correlationData, boolean ack, String cause) {
        System.err.println(("---- confirm ----ack=" + ack + "  cause=" + String.valueOf(cause)));
        System.err.println(("correlationData -->" + correlationData));
        if(ack){
            // 交换机接收到
            System.err.println(("---- confirm ----ack==true  cause=" + cause));
        }else{
            // 没有接收到
            System.err.println(("---- confirm ----ack==false  cause=" + cause));
        }
    }
}

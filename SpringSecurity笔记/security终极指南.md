...
//                .antMatchers("/r/r2").hasAuthority("p2")
                ...
                .usernameParameter("username")  // 自定义表单用户名的参数名
                .passwordParameter("password")  // 自定义表单密码的参数名
                .and()
                .sessionManagement()
...
### 1.2 实现userDetailService接口

- 会传入username
- 可以根据username查数据库拿到密码
- 生成UserDetails对象
- 拿到用户权限信息
- security默认会去比较

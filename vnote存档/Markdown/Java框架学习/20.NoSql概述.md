...
![](_v_images/20190806164025853_1820.png)  
...
![](_v_images/20190806172816519_20331.png)  

### 5.2 多数据源和多数据类型存储相关  
![](_v_images/20190806173605403_29864.png =536x)  
#### 5.2.1 商品基本信息  
...
- 图形  
![](_v_images/20190806192001693_9387.png)  
## 7. NoSql数据库的分类  
### 7.1 KV键值对  

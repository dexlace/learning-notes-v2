...
### 3.2 properties属性  
![](_v_images/20190716104928906_17134.png)  
### 3.3 settings属性  
...
#### 4.1.2 多个参数处理  
##### 4.1.2.1 常见两种参数处理方法  
![](_v_images/20190716160052579_409.png =963x)  
##### 4.1.2.2 传入pojo参数  
![](_v_images/20190716181010235_24311.png =706x)  
##### 4.1.2.3 传入自定义map参数  
![](_v_images/20190718132835770_32605.png =676x)  
### 4.2 ${}和#{}的区别  
![](_v_images/20190718153736789_11024.png =894x)  
### 4.3 查询结果集返回值处理  
#### 4.3.1 返回list和map  
![](_v_images/20190718155538877_8179.png =795x)  
![](_v_images/20190718160246284_3397.png =632x)  
![](_v_images/20190718161106904_12134.png =795x)  
#### 4.3.2 简单自定义封装结果集  
![](_v_images/20190718161908335_16238.png =774x)  
![](_v_images/20190718163414790_13181.png =628x)  
#### 4.3.3 自定义多对一级联查询结果集封装规则  
![](_v_images/20190718165950123_7951.png =910x)  
#### 4.3.4 使用association实现多对一分步查询结果集封装  
![](_v_images/20190718171207026_22872.png =1010x)  
#### 4.3.5 多对一的分步查询中的懒加载设置  
![](_v_images/20190718172432933_19826.png =637x)  
#### 4.3.6 一对多的结果集封装  
![](_v_images/20190718182750303_31345.png =668x)  
#### 4.3.7 一对多分步查询结果集封装  
![](_v_images/20190718205214820_2142.png =1030x)  
#### 4.3.8 鉴别器  
![](_v_images/20190718211410753_5656.png =836x)  
## 五、 动态sql语句  
![](_v_images/20190720203424200_4766.png =671x)  
### 5.1 查询sql之if和where  
![](_v_images/20190720204354882_11740.png =1009x)  
### 5.2 查询sql之trim  
![](_v_images/20190720210750965_16017.png =760x)  
### 5.4 查询sql之choose  
![](_v_images/20190720213931924_26198.png =748x)  
### 5.5 更新sql之set  
![](_v_images/20190720214607976_30166.png =831x)  
### 5.6 批量查询之foreach  
![](_v_images/20190720220250288_4715.png =665x)  
### 5.7 批量保存之foreach  
![](_v_images/20190720221250421_11949.png =696x)  
### 5.7 sql片段  
...
#### 7.3.2 映射配置文件及其对应接口  
![](_v_images/20190722113809258_20357.png =543x)  

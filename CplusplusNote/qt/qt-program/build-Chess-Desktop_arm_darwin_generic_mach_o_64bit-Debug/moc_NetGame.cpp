...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NetGame_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_NetGame_t qt_meta_stringdata_NetGame = {
    {
        QT_MOC_LITERAL(0, 7),  // "NetGame"
        QT_MOC_LITERAL(8, 17),  // "slotNewConnection"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 8)   // "slotRecv"
    },
    "NetGame",
    "slotNewConnection",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_NetGame[] = {
...
Q_CONSTINIT const QMetaObject NetGame::staticMetaObject = { {
    QMetaObject::SuperData::link<Board::staticMetaObject>(),
    qt_meta_stringdata_NetGame.offsetsAndSizes,
    qt_meta_data_NetGame,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_NetGame_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NetGame, std::true_type>,

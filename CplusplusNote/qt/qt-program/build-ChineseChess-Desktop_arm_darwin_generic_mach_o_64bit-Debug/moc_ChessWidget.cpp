...
#include <memory>
#include "../ChineseChess/ChessWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ChessWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ChessWidget_t qt_meta_stringdata_ChessWidget = {
    {
        QT_MOC_LITERAL(0, 11)   // "ChessWidget"
    },
    "ChessWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_ChessWidget[] = {
...
Q_CONSTINIT const QMetaObject ChessWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ChessWidget.offsetsAndSizes,
    qt_meta_data_ChessWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ChessWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ChessWidget, std::true_type>
    >,
    nullptr
} };
